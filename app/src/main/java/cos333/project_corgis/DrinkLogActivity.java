...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        ...
        contactnum = pref.getString("contactnum", "");
...
//                    AccessToken.getCurrentAccessToken().getUserId(), params);
    ...
    private void displayBAC() {
        ...
        double BAC_threshold = (double) R.string.threshold;
        if (BAC >= BAC_threshold) {
            ...
            String message = "Hi "+ contactname + ", " +
                    ...
                    lastname + " has a BAC of 0.08 or higher. They may be too drunk to take care" +
                    "of them properly, so you should go find them! (this message was automatically" +
                    "generated by Holic)";
            emergency.sendTextMessage(contactnum, null, message, null, null);
        }
